...
The raw data consist `r ncol(homicide_data)` variables and `r nrow(homicide_data)` observations. Each observation includes uid, reported date, victim first and last name, race, age, sex, city, state, lat, lon, and disposition.
